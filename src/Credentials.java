...
public class Credentials {
    private static final double CREDENTIALS_PANEL_X_COOR = GUI.STAGE_SIZE * 4.0/3.0;
    private static final double CREDENTIALS_PANEL_Y_COOR = GUI.STAGE_SIZE * 4.0/3.0;
